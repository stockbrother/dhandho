...
public class ClassListSourceFileProvider implements Provider<List<SourceFile>> {
	List<Class<?>> classes = new ArrayList<>();

	public ClassListSourceFileProvider() {

	}

	public ClassListSourceFileProvider add(Class<?>... classes) {
