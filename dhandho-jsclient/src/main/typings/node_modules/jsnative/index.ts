...
import { TestBed, TestModuleMetadata, async, fakeAsync } from '@angular/core/testing';
...
//export function angular_async( run: () => void ): (done: any) => void {
//    return async(run);
//}
//
...
export function jasmine_it( desc: string, action: (done: DoneFn) => void ): void {
    it( desc, action );
}
